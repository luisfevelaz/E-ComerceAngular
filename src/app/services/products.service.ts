...
export class ProductsService {
  ...
  public getPhones(){
    return [this.products[0],this.products[1],this.products[2],this.products[3],this.products[4],this.products[5]];
  }

  public getCam(){
    return [this.products[6],this.products[7],this.products[8],this.products[9],this.products[10],this.products[11]];
  }
  public getBlanca(){
